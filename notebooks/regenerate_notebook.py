...
code([
    ...
    "# directly contains ASVspoof2019_LA_cm_protocols.\n",
    "ROOT_CANDIDATES = [\n",
    ...
    "    if not root.exists():\n",
    "        continue\n",
    "    log(f\"  Found root: {root}\")\n",
    "    subdirs = [root, root / \"LA\", root / \"asvpoof-2019-dataset\", root / \"asvpoof-2019-dataset/LA\"]\n",
    ...
    "    log(\"  -> Then re-run this cell\")\n",
    "    raise FileNotFoundError(\"ASVspoof 2019 dataset not added via +Data button\")\n",
    "\n",
